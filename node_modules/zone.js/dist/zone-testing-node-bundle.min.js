...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */Zone.__load_patch("ZoneAwarePromise",(function(e,t,n){var r=Object.getOwnPropertyDescriptor,o=Object.defineProperty,i=n.symbol,s=[],a=!0===e[i("DISABLE_WRAPPING_UNCAUGHT_PROMISE_REJECTION")],c=i("Promise"),u=i("then");n.onUnhandledError=function(e){if(n.showUncaughtError()){var t=e&&e.rejection;t?console.error("Unhandled Promise rejection:",t instanceof Error?t.message:t,"; Zone:",e.zone.name,"; Task:",e.task&&e.task.source,"; Value:",t,t instanceof Error?t.stack:void 0):console.error(e)}},n.microtaskDrainDone=function(){for(var e=function(){var e=s.shift();try{e.zone.runGuarded((function(){if(e.throwOriginal)throw e.rejection;throw e}))}catch(e){!function r(e){n.onUnhandledError(e);try{var r=t[l];"function"==typeof r&&r.call(this,e)}catch(e){}}(e)}};s.length;)e()};var l=i("unhandledPromiseRejectionHandler");function h(e){return e&&e.then}function f(e){return e}function p(e){return C.reject(e)}var d=i("state"),y=i("value"),k=i("finally"),_=i("parentPromiseValue"),m=i("parentPromiseState"),v=null,T=!0,g=!1;function b(e,t){return function(n){try{w(e,t,n)}catch(t){w(e,!1,t)}}}var S=i("currentTaskTrace");function w(e,r,i){var c,u=(c=!1,function e(t){return function(){c||(c=!0,t.apply(null,arguments))}});if(e===i)throw new TypeError("Promise resolved with itself");if(e[d]===v){var l=null;try{"object"!=typeof i&&"function"!=typeof i||(l=i&&i.then)}catch(t){return u((function(){w(e,!1,t)}))(),e}if(r!==g&&i instanceof C&&i.hasOwnProperty(d)&&i.hasOwnProperty(y)&&i[d]!==v)Z(i),w(e,i[d],i[y]);else if(r!==g&&"function"==typeof l)try{l.call(i,u(b(e,r)),u(b(e,!1)))}catch(t){u((function(){w(e,!1,t)}))()}else{e[d]=r;var h=e[y];if(e[y]=i,e[k]===k&&r===T&&(e[d]=e[m],e[y]=e[_]),r===g&&i instanceof Error){var f=t.currentTask&&t.currentTask.data&&t.currentTask.data.__creationTrace__;f&&o(i,S,{configurable:!0,enumerable:!1,writable:!0,value:f})}for(var p=0;p<h.length;)j(e,h[p++],h[p++],h[p++],h[p++]);if(0==h.length&&r==g){e[d]=0;var P=i;try{throw new Error("Uncaught (in promise): "+function e(t){return t&&t.toString===Object.prototype.toString?(t.constructor&&t.constructor.name||"")+": "+JSON.stringify(t):t?t.toString():Object.prototype.toString.call(t)}(i)+(i&&i.stack?"\n"+i.stack:""))}catch(e){P=e}a&&(P.throwOriginal=!0),P.rejection=i,P.promise=e,P.zone=t.current,P.task=t.currentTask,s.push(P),n.scheduleMicroTask()}}}return e}var E=i("rejectionHandledHandler");function Z(e){if(0===e[d]){try{var n=t[E];n&&"function"==typeof n&&n.call(this,{rejection:e[y],promise:e})}catch(e){}e[d]=g;for(var r=0;r<s.length;r++)e===s[r].promise&&s.splice(r,1)}}function j(e,t,n,r,o){Z(e);var i=e[d],s=i?"function"==typeof r?r:f:"function"==typeof o?o:p;t.scheduleMicroTask("Promise.then",(function(){try{var r=e[y],o=!!n&&k===n[k];o&&(n[_]=r,n[m]=i);var a=t.run(s,void 0,o&&s!==p&&s!==f?[]:[r]);w(n,!0,a)}catch(e){w(n,!1,e)}}),n)}var D=function(){},A=e.AggregateError,C=function(){function e(t){var n=this;if(!(n instanceof e))throw new Error("Must be an instanceof Promise.");n[d]=v,n[y]=[];try{t&&t(b(n,T),b(n,g))}catch(e){w(n,!1,e)}}return e.toString=function(){return"function ZoneAwarePromise() { [native code] }"},e.resolve=function(e){return w(new this(null),T,e)},e.reject=function(e){return w(new this(null),g,e)},e.any=function(t){if(!t||"function"!=typeof t[Symbol.iterator])return Promise.reject(new A([],"All promises were rejected"));var n=[],r=0;try{for(var o=0,i=t;o<i.length;o++)r++,n.push(e.resolve(i[o]))}catch(e){return Promise.reject(new A([],"All promises were rejected"))}if(0===r)return Promise.reject(new A([],"All promises were rejected"));var s=!1,a=[];return new e((function(e,t){for(var o=0;o<n.length;o++)n[o].then((function(t){s||(s=!0,e(t))}),(function(e){a.push(e),0==--r&&(s=!0,t(new A(a,"All promises were rejected")))}))}))},e.race=function(e){var t,n,r=new this((function(e,r){t=e,n=r}));function o(e){t(e)}function i(e){n(e)}for(var s=0,a=e;s<a.length;s++){var c=a[s];h(c)||(c=this.resolve(c)),c.then(o,i)}return r},e.all=function(t){return e.allWithCallback(t)},e.allSettled=function(t){return(this&&this.prototype instanceof e?this:e).allWithCallback(t,{thenCallback:function(e){return{status:"fulfilled",value:e}},errorCallback:function(e){return{status:"rejected",reason:e}}})},e.allWithCallback=function(e,t){for(var n,r,o=new this((function(e,t){n=e,r=t})),i=2,s=0,a=[],c=function(e){h(e)||(e=u.resolve(e));var o=s;try{e.then((function(e){a[o]=t?t.thenCallback(e):e,0==--i&&n(a)}),(function(e){t?(a[o]=t.errorCallback(e),0==--i&&n(a)):r(e)}))}catch(e){r(e)}i++,s++},u=this,l=0,f=e;l<f.length;l++)c(f[l]);return 0==(i-=2)&&n(a),o},Object.defineProperty(e.prototype,Symbol.toStringTag,{get:function(){return"Promise"},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,Symbol.species,{get:function(){return e},enumerable:!1,configurable:!0}),e.prototype.then=function(n,r){var o=this.constructor[Symbol.species];o&&"function"==typeof o||(o=this.constructor||e);var i=new o(D),s=t.current;return this[d]==v?this[y].push(s,i,n,r):j(this,s,i,n,r),i},e.prototype.catch=function(e){return this.then(null,e)},e.prototype.finally=function(n){var r=this.constructor[Symbol.species];r&&"function"==typeof r||(r=e);var o=new r(D);o[k]=k;var i=t.current;return this[d]==v?this[y].push(i,o,n,n):j(this,i,o,n,n),o},e}();C.resolve=C.resolve,C.reject=C.reject,C.race=C.race,C.all=C.all;var I=e[c]=e.Promise;e.Promise=C;var O=i("thenPatched");function F(e){var t=e.prototype,n=r(t,"then");if(!n||!1!==n.writable&&n.configurable){var o=t.then;t[u]=o,e.prototype.then=function(e,t){var n=this;return new C((function(e,t){o.call(n,e,t)})).then(e,t)},e[O]=!0}}return n.patchThen=F,I&&(F(I),P(e,"fetch",(function(e){return function t(e){return function(t,n){var r=e.apply(t,n);if(r instanceof C)return r;var o=r.constructor;return o[O]||F(o),r}}(e)}))),Promise[t.__symbol__("uncaughtPromiseErrors")]=s,C})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
var j=!1;if("undefined"!=typeof window)try{var D=Object.defineProperty({},"passive",{get:function(){j=!0}});window.addEventListener("test",D,D),window.removeEventListener("test",D,D)}catch(e){j=!1}var A={useG:!0},C={},I={},O=new RegExp("^"+c+"(\\w+)(true|false)$"),F=h("propagationStopped");function x(e,t){var n=(t?t(e):e)+a,r=(t?t(e):e)+s,o=c+n,i=c+r;C[e]={},C[e].false=o,C[e].true=i}function z(e,t,r,u){var l=u&&u.add||o,f=u&&u.rm||i,p=u&&u.listeners||"eventListeners",d=u&&u.rmAll||"removeAllListeners",y=h(l),k="."+l+":",m=function(e,t,n){if(!e.isRemoved){var r,o=e.callback;"object"==typeof o&&o.handleEvent&&(e.callback=function(e){return o.handleEvent(e)},e.originalDelegate=o);try{e.invoke(e,t,[n])}catch(e){r=e}var i=e.options;return i&&"object"==typeof i&&i.once&&t[f].call(t,n.type,e.originalDelegate?e.originalDelegate:e.callback,i),r}};function v(n,r,o){if(r=r||e.event){var i=n||r.target||e,c=i[C[r.type][o?s:a]];if(c){var u=[];if(1===c.length)(f=m(c[0],i,r))&&u.push(f);else for(var l=c.slice(),h=0;h<l.length&&(!r||!0!==r[F]);h++){var f;(f=m(l[h],i,r))&&u.push(f)}if(1===u.length)throw u[0];var p=function(e){var n=u[e];t.nativeScheduleMicroTask((function(){throw n}))};for(h=0;h<u.length;h++)p(h)}}}var T=function(e){return v(this,e,!1)},g=function(e){return v(this,e,!0)};function b(t,r){if(!t)return!1;var o=!0;r&&void 0!==r.useG&&(o=r.useG);var i=r&&r.vh,u=!0;r&&void 0!==r.chkDup&&(u=r.chkDup);var m=!1;r&&void 0!==r.rt&&(m=r.rt);for(var v=t;v&&!v.hasOwnProperty(l);)v=n(v);if(!v&&t[l]&&(v=t),!v)return!1;if(v[y])return!1;var b,S=r&&r.eventNameToString,w={},P=v[y]=v[l],E=v[h(f)]=v[f],D=v[h(p)]=v[p],F=v[h(d)]=v[d];function z(e,t){return!j&&"object"==typeof e&&e?!!e.capture:j&&t?"boolean"==typeof e?{capture:e,passive:!0}:e?"object"==typeof e&&!1!==e.passive?Object.assign(Object.assign({},e),{passive:!0}):e:{passive:!0}:e}r&&r.prepend&&(b=v[h(r.prepend)]=v[r.prepend]);var R=o?function(e){if(!w.isExisting)return P.call(w.target,w.eventName,w.capture?g:T,w.options)}:function(e){return P.call(w.target,w.eventName,e.invoke,w.options)},N=o?function(e){if(!e.isRemoved){var t=C[e.eventName],n=void 0;t&&(n=t[e.capture?s:a]);var r=n&&e.target[n];if(r)for(var o=0;o<r.length;o++)if(r[o]===e){r.splice(o,1),e.isRemoved=!0,0===r.length&&(e.allRemoved=!0,e.target[n]=null);break}}if(e.allRemoved)return E.call(e.target,e.eventName,e.capture?g:T,e.options)}:function(e){return E.call(e.target,e.eventName,e.invoke,e.options)},L=r&&r.diff?r.diff:function(e,t){var n=typeof t;return"function"===n&&e.callback===t||"object"===n&&e.originalDelegate===t},q=Zone[h("UNPATCHED_EVENTS")],H=e[h("PASSIVE_EVENTS")],U=function(t,n,c,l,h,f){return void 0===h&&(h=!1),void 0===f&&(f=!1),function(){var p=this||e,d=arguments[0];r&&r.transferEventName&&(d=r.transferEventName(d));var y=arguments[1];if(!y)return t.apply(this,arguments);if(_&&"uncaughtException"===d)return t.apply(this,arguments);var k=!1;if("function"!=typeof y){if(!y.handleEvent)return t.apply(this,arguments);k=!0}if(!i||i(t,y,p,arguments)){var m=j&&!!H&&-1!==H.indexOf(d),v=z(arguments[2],m);if(q)for(var T=0;T<q.length;T++)if(d===q[T])return m?t.call(p,d,y,v):t.apply(this,arguments);var g=!!v&&("boolean"==typeof v||v.capture),b=!(!v||"object"!=typeof v)&&v.once,P=Zone.current,E=C[d];E||(x(d,S),E=C[d]);var Z,D=E[g?s:a],O=p[D],F=!1;if(O){if(F=!0,u)for(T=0;T<O.length;T++)if(L(O[T],y))return}else O=p[D]=[];var M=p.constructor.name,R=I[M];R&&(Z=R[d]),Z||(Z=M+n+(S?S(d):d)),w.options=v,b&&(w.options.once=!1),w.target=p,w.capture=g,w.eventName=d,w.isExisting=F;var N=o?A:void 0;N&&(N.taskData=w);var U=P.scheduleEventTask(Z,y,N,c,l);return w.target=null,N&&(N.taskData=null),b&&(v.once=!0),(j||"boolean"!=typeof U.options)&&(U.options=v),U.target=p,U.capture=g,U.eventName=d,k&&(U.originalDelegate=y),f?O.unshift(U):O.push(U),h?p:void 0}}};return v[l]=U(P,k,R,N,m),b&&(v.prependListener=U(b,".prependListener:",(function(e){return b.call(w.target,w.eventName,e.invoke,w.options)}),N,m,!0)),v[f]=function(){var t=this||e,n=arguments[0];r&&r.transferEventName&&(n=r.transferEventName(n));var o=arguments[2],u=!!o&&("boolean"==typeof o||o.capture),l=arguments[1];if(!l)return E.apply(this,arguments);if(!i||i(E,l,t,arguments)){var h,f=C[n];f&&(h=f[u?s:a]);var p=h&&t[h];if(p)for(var d=0;d<p.length;d++){var y=p[d];if(L(y,l)){if(p.splice(d,1),y.isRemoved=!0,0===p.length&&(y.allRemoved=!0,t[h]=null,"string"==typeof n)){var k=c+"ON_PROPERTY"+n;t[k]=null}return y.zone.cancelTask(y),m?t:void 0}}return E.apply(this,arguments)}},v[p]=function(){var t=this||e,n=arguments[0];r&&r.transferEventName&&(n=r.transferEventName(n));for(var o=[],i=M(t,S?S(n):n),s=0;s<i.length;s++){var a=i[s],c=a.originalDelegate?a.originalDelegate:a.callback;o.push(c)}return o},v[d]=function(){var t=this||e,n=arguments[0];if(n){r&&r.transferEventName&&(n=r.transferEventName(n));var o=C[n];if(o){var i=o.false,s=o.true,a=t[i],c=t[s];if(a){var u=a.slice();for(p=0;p<u.length;p++)this[f].call(this,n,(l=u[p]).originalDelegate?l.originalDelegate:l.callback,l.options)}if(c)for(u=c.slice(),p=0;p<u.length;p++){var l;this[f].call(this,n,(l=u[p]).originalDelegate?l.originalDelegate:l.callback,l.options)}}}else{for(var h=Object.keys(t),p=0;p<h.length;p++){var y=h[p],k=O.exec(y),_=k&&k[1];_&&"removeListener"!==_&&this[d].call(this,_)}this[d].call(this,"removeListener")}if(m)return this},Z(v[l],P),Z(v[f],E),F&&Z(v[d],F),D&&Z(v[p],D),!0}for(var S=[],w=0;w<r.length;w++)S[w]=b(r[w],u);return S}function M(e,t){if(!t){var n=[];for(var r in e){var o=O.exec(r),i=o&&o[1];if(i&&(!t||i===t)){var s=e[r];if(s)for(var a=0;a<s.length;a++)n.push(s[a])}}return n}var c=C[t];c||(x(t),c=C[t]);var u=e[c.false],l=e[c.true];return u?l?u.concat(l):u.slice():l?l.slice():[]}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
