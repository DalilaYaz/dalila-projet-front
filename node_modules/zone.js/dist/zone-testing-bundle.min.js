...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */Zone.__load_patch("ZoneAwarePromise",(function(e,t,n){var r=Object.getOwnPropertyDescriptor,o=Object.defineProperty,i=n.symbol,a=[],s=!0===e[i("DISABLE_WRAPPING_UNCAUGHT_PROMISE_REJECTION")],c=i("Promise"),u=i("then");n.onUnhandledError=function(e){if(n.showUncaughtError()){var t=e&&e.rejection;t?console.error("Unhandled Promise rejection:",t instanceof Error?t.message:t,"; Zone:",e.zone.name,"; Task:",e.task&&e.task.source,"; Value:",t,t instanceof Error?t.stack:void 0):console.error(e)}},n.microtaskDrainDone=function(){for(var e=function(){var e=a.shift();try{e.zone.runGuarded((function(){if(e.throwOriginal)throw e.rejection;throw e}))}catch(e){!function r(e){n.onUnhandledError(e);try{var r=t[l];"function"==typeof r&&r.call(this,e)}catch(e){}}(e)}};a.length;)e()};var l=i("unhandledPromiseRejectionHandler");function h(e){return e&&e.then}function f(e){return e}function p(e){return C.reject(e)}var d=i("state"),y=i("value"),v=i("finally"),m=i("parentPromiseValue"),_=i("parentPromiseState"),g=null,k=!0,T=!1;function b(e,t){return function(n){try{S(e,t,n)}catch(t){S(e,!1,t)}}}var E=i("currentTaskTrace");function S(e,r,i){var c,u=(c=!1,function e(t){return function(){c||(c=!0,t.apply(null,arguments))}});if(e===i)throw new TypeError("Promise resolved with itself");if(e[d]===g){var l=null;try{"object"!=typeof i&&"function"!=typeof i||(l=i&&i.then)}catch(t){return u((function(){S(e,!1,t)}))(),e}if(r!==T&&i instanceof C&&i.hasOwnProperty(d)&&i.hasOwnProperty(y)&&i[d]!==g)P(i),S(e,i[d],i[y]);else if(r!==T&&"function"==typeof l)try{l.call(i,u(b(e,r)),u(b(e,!1)))}catch(t){u((function(){S(e,!1,t)}))()}else{e[d]=r;var h=e[y];if(e[y]=i,e[v]===v&&r===k&&(e[d]=e[_],e[y]=e[m]),r===T&&i instanceof Error){var f=t.currentTask&&t.currentTask.data&&t.currentTask.data.__creationTrace__;f&&o(i,E,{configurable:!0,enumerable:!1,writable:!0,value:f})}for(var p=0;p<h.length;)Z(e,h[p++],h[p++],h[p++],h[p++]);if(0==h.length&&r==T){e[d]=0;var w=i;try{throw new Error("Uncaught (in promise): "+function e(t){return t&&t.toString===Object.prototype.toString?(t.constructor&&t.constructor.name||"")+": "+JSON.stringify(t):t?t.toString():Object.prototype.toString.call(t)}(i)+(i&&i.stack?"\n"+i.stack:""))}catch(e){w=e}s&&(w.throwOriginal=!0),w.rejection=i,w.promise=e,w.zone=t.current,w.task=t.currentTask,a.push(w),n.scheduleMicroTask()}}}return e}var w=i("rejectionHandledHandler");function P(e){if(0===e[d]){try{var n=t[w];n&&"function"==typeof n&&n.call(this,{rejection:e[y],promise:e})}catch(e){}e[d]=T;for(var r=0;r<a.length;r++)e===a[r].promise&&a.splice(r,1)}}function Z(e,t,n,r,o){P(e);var i=e[d],a=i?"function"==typeof r?r:f:"function"==typeof o?o:p;t.scheduleMicroTask("Promise.then",(function(){try{var r=e[y],o=!!n&&v===n[v];o&&(n[m]=r,n[_]=i);var s=t.run(a,void 0,o&&a!==p&&a!==f?[]:[r]);S(n,!0,s)}catch(e){S(n,!1,e)}}),n)}var O=function(){},j=e.AggregateError,C=function(){function e(t){var n=this;if(!(n instanceof e))throw new Error("Must be an instanceof Promise.");n[d]=g,n[y]=[];try{t&&t(b(n,k),b(n,T))}catch(e){S(n,!1,e)}}return e.toString=function(){return"function ZoneAwarePromise() { [native code] }"},e.resolve=function(e){return S(new this(null),k,e)},e.reject=function(e){return S(new this(null),T,e)},e.any=function(t){if(!t||"function"!=typeof t[Symbol.iterator])return Promise.reject(new j([],"All promises were rejected"));var n=[],r=0;try{for(var o=0,i=t;o<i.length;o++)r++,n.push(e.resolve(i[o]))}catch(e){return Promise.reject(new j([],"All promises were rejected"))}if(0===r)return Promise.reject(new j([],"All promises were rejected"));var a=!1,s=[];return new e((function(e,t){for(var o=0;o<n.length;o++)n[o].then((function(t){a||(a=!0,e(t))}),(function(e){s.push(e),0==--r&&(a=!0,t(new j(s,"All promises were rejected")))}))}))},e.race=function(e){var t,n,r=new this((function(e,r){t=e,n=r}));function o(e){t(e)}function i(e){n(e)}for(var a=0,s=e;a<s.length;a++){var c=s[a];h(c)||(c=this.resolve(c)),c.then(o,i)}return r},e.all=function(t){return e.allWithCallback(t)},e.allSettled=function(t){return(this&&this.prototype instanceof e?this:e).allWithCallback(t,{thenCallback:function(e){return{status:"fulfilled",value:e}},errorCallback:function(e){return{status:"rejected",reason:e}}})},e.allWithCallback=function(e,t){for(var n,r,o=new this((function(e,t){n=e,r=t})),i=2,a=0,s=[],c=function(e){h(e)||(e=u.resolve(e));var o=a;try{e.then((function(e){s[o]=t?t.thenCallback(e):e,0==--i&&n(s)}),(function(e){t?(s[o]=t.errorCallback(e),0==--i&&n(s)):r(e)}))}catch(e){r(e)}i++,a++},u=this,l=0,f=e;l<f.length;l++)c(f[l]);return 0==(i-=2)&&n(s),o},Object.defineProperty(e.prototype,Symbol.toStringTag,{get:function(){return"Promise"},enumerable:!1,configurable:!0}),Object.defineProperty(e.prototype,Symbol.species,{get:function(){return e},enumerable:!1,configurable:!0}),e.prototype.then=function(n,r){var o=this.constructor[Symbol.species];o&&"function"==typeof o||(o=this.constructor||e);var i=new o(O),a=t.current;return this[d]==g?this[y].push(a,i,n,r):Z(this,a,i,n,r),i},e.prototype.catch=function(e){return this.then(null,e)},e.prototype.finally=function(n){var r=this.constructor[Symbol.species];r&&"function"==typeof r||(r=e);var o=new r(O);o[v]=v;var i=t.current;return this[d]==g?this[y].push(i,o,n,n):Z(this,i,o,n,n),o},e}();C.resolve=C.resolve,C.reject=C.reject,C.race=C.race,C.all=C.all;var A=e[c]=e.Promise;e.Promise=C;var I=i("thenPatched");function M(e){var t=e.prototype,n=r(t,"then");if(!n||!1!==n.writable&&n.configurable){var o=t.then;t[u]=o,e.prototype.then=function(e,t){var n=this;return new C((function(e,t){o.call(n,e,t)})).then(e,t)},e[I]=!0}}return n.patchThen=M,A&&(M(A),D(e,"fetch",(function(e){return function t(e){return function(t,n){var r=e.apply(t,n);if(r instanceof C)return r;var o=r.constructor;return o[I]||M(o),r}}(e)}))),Promise[t.__symbol__("uncaughtPromiseErrors")]=a,C})),
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function J(e,t,n,r,o){var i=Zone.__symbol__(r);if(!t[i]){var a=t[i]=t[r];t[r]=function(i,s,c){return s&&s.prototype&&o.forEach((function(t){var o="".concat(n,".").concat(r,"::")+t,i=s.prototype;if(i.hasOwnProperty(t)){var a=e.ObjectGetOwnPropertyDescriptor(i,t);a&&a.value?(a.value=e.wrapWithCurrentZone(a.value,o),e._redefineProperty(s.prototype,t,a)):i[t]&&(i[t]=e.wrapWithCurrentZone(i[t],o))}else i[t]&&(i[t]=e.wrapWithCurrentZone(i[t],o))})),a.call(t,i,s,c)},e.attachOriginToPatched(t[r],a)}}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
