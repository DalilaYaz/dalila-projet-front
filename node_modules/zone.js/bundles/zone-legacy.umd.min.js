...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */function p(e,t){var r=t.getGlobalObjects(),n=r.eventNames,o=r.globalSources,a=r.zoneSymbolEventNames,i=r.TRUE_STR,c=r.FALSE_STR,l=r.ZONE_SYMBOL_PREFIX,s="ApplicationCache,EventSource,FileReader,InputMethodContext,MediaController,MessagePort,Node,Performance,SVGElementInstance,SharedWorker,TextTrack,TextTrackCue,TextTrackList,WebKitNamedFlow,Window,Worker,WorkerGlobalScope,XMLHttpRequest,XMLHttpRequestEventTarget,XMLHttpRequestUpload,IDBRequest,IDBOpenDBRequest,IDBDatabase,IDBTransaction,IDBCursor,DBIndex,WebSocket".split(","),p=[],u=e.wtf,d="Anchor,Area,Audio,BR,Base,BaseFont,Body,Button,Canvas,Content,DList,Directory,Div,Embed,FieldSet,Font,Form,Frame,FrameSet,HR,Head,Heading,Html,IFrame,Image,Input,Keygen,LI,Label,Legend,Link,Map,Marquee,Media,Menu,Meta,Meter,Mod,OList,Object,OptGroup,Option,Output,Paragraph,Pre,Progress,Quote,Script,Select,Source,Span,Style,TableCaption,TableCell,TableCol,Table,TableRow,TableSection,TextArea,Title,Track,UList,Unknown,Video".split(",");u?p=d.map((function(e){return"HTML"+e+"Element"})).concat(s):e.EventTarget?p.push("EventTarget"):p=s;for(var f=e.__Zone_disable_IE_check||!1,g=e.__Zone_enable_cross_context_check||!1,b=t.isIEOrEdge(),m="[object FunctionWrapper]",v="function __BROWSERTOOLS_CONSOLE_SAFEFUNC() { [native code] }",h={MSPointerCancel:"pointercancel",MSPointerDown:"pointerdown",MSPointerEnter:"pointerenter",MSPointerHover:"pointerhover",MSPointerLeave:"pointerleave",MSPointerMove:"pointermove",MSPointerOut:"pointerout",MSPointerOver:"pointerover",MSPointerUp:"pointerup"},y=0;y<n.length;y++){var _=l+((S=n[y])+c),O=l+(S+i);a[S]={},a[S][c]=_,a[S][i]=O}for(y=0;y<d.length;y++)for(var w=d[y],k=o[w]={},E=0;E<n.length;E++){var S;k[S=n[E]]=w+".addEventListener:"+S}var P=[];for(y=0;y<p.length;y++){var j=e[p[y]];P.push(j&&j.prototype)}return t.patchEventTarget(e,t,P,{vh:function(e,t,r,n){if(!f&&b){if(g)try{var o;if((o=t.toString())===m||o==v)return e.apply(r,n),!1}catch(t){return e.apply(r,n),!1}else if((o=t.toString())===m||o==v)return e.apply(r,n),!1}else if(g)try{t.toString()}catch(t){return e.apply(r,n),!1}return!0},transferEventName:function(e){return h[e]||e}}),Zone[t.symbol("patchEventTarget")]=!!e.EventTarget,!0}
/**
     * @license
     * Copyright Google LLC All Rights Reserved.
     *
