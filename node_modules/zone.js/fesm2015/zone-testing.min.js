 ...
 * found in the LICENSE file at https://angular.io/license
 */
Zone.__load_patch("mocha",((e,t)=>{const n=e.Mocha;if(void 0===n)return;if(void 0===t)throw new Error("Missing Zone.js");const r=t.ProxyZoneSpec,s=t.SyncTestZoneSpec;if(!r)throw new Error("Missing ProxyZoneSpec");if(n.__zone_patch__)throw new Error('"Mocha" has already been patched with "Zone".');n.__zone_patch__=!0;const i=t.current,o=i.fork(new s("Mocha.describe"));let c=null;const a=i.fork(new r),u={after:e.after,afterEach:e.afterEach,before:e.before,beforeEach:e.beforeEach,describe:e.describe,it:e.it};function l(e,t,n){for(let r=0;r<e.length;r++){let s=e[r];"function"==typeof s&&(e[r]=0===s.length?t(s):n(s),e[r].toString=function(){return s.toString()})}return e}function h(e){return l(e,(function(e){return function(){return o.run(e,this,arguments)}}))}function d(e){return l(e,(function(e){return function(){return c.run(e,this)}}),(function(e){return function(t){return c.run(e,this,[t])}}))}function p(e){return l(e,(function(e){return function(){return a.run(e,this)}}),(function(e){return function(t){return a.run(e,this,[t])}}))}var T,f;e.describe=e.suite=function(){return u.describe.apply(this,h(arguments))},e.xdescribe=e.suite.skip=function(){return u.describe.skip.apply(this,h(arguments))},e.describe.only=e.suite.only=function(){return u.describe.only.apply(this,h(arguments))},e.it=e.specify=e.test=function(){return u.it.apply(this,d(arguments))},e.xit=e.xspecify=function(){return u.it.skip.apply(this,d(arguments))},e.it.only=e.test.only=function(){return u.it.only.apply(this,d(arguments))},e.after=e.suiteTeardown=function(){return u.after.apply(this,p(arguments))},e.afterEach=e.teardown=function(){return u.afterEach.apply(this,d(arguments))},e.before=e.suiteSetup=function(){return u.before.apply(this,p(arguments))},e.beforeEach=e.setup=function(){return u.beforeEach.apply(this,d(arguments))},T=n.Runner.prototype.runTest,f=n.Runner.prototype.run,n.Runner.prototype.runTest=function(e){t.current.scheduleMicroTask("mocha.forceTask",(()=>{T.call(this,e)}))},n.Runner.prototype.run=function(e){return this.on("test",(e=>{c=i.fork(new r)})),this.on("fail",((e,t)=>{const n=c&&c.get("ProxyZoneSpec");if(n&&t)try{t.message+=n.getAndClearPendingTasksInfo()}catch(e){}})),f.call(this,e)}})),
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
